...
public class Constants {
    ...
    public static final String MBTA_URL = "http://realtime.mbta.com/developer/api/v2";
    public static final String ROUTE_TYPE_BUS = "3";
    ...
    public static String STOP_KEY = "stopId";
